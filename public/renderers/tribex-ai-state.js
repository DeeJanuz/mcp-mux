...
(function () {
  ...
  var context = {
    ...
    windowResumeListenerBound: false,
    pauseSignalListenerBound: false,
    pauseSignalChannel: null,
    pausePolling: {
      threadId: null,
      timeoutId: null,
      intervalMs: 0,
  ...
  window.__tribexAiState = {
    ...
    checkThreadPause: api.checkThreadPause,
    connect: api.connect,
    continueThreadPause: api.continueThreadPause,
    ...
    schedulePauseCheckBurst: api.schedulePauseCheckBurst,
    ...
    closeWorkspaceFileMoveComposer: api.closeWorkspaceFileMoveComposer,
    closeWorkspaceFolderComposer: api.closeWorkspaceFolderComposer,
    ...
    moveSelectedWorkspaceFile: api.moveSelectedWorkspaceFile,
    moveWorkspaceFileToFolder: api.moveWorkspaceFileToFolder,
    moveWorkspaceFolderToFolder: api.moveWorkspaceFolderToFolder,
