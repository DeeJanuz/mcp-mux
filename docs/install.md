...
1. Download **[MCPViews.dmg](https://github.com/DeeJanuz/mcpviews/releases/download/v0.2.42/MCPViews_0.2.42_aarch64.dmg)** from the release
...
|-----------|--------|----------|
| Setup wizard | `.exe` | [MCPViews_setup.exe](https://github.com/DeeJanuz/mcpviews/releases/download/v0.2.42/MCPViews_0.2.42_x64-setup.exe) |
| MSI package | `.msi` | [MCPViews.msi](https://github.com/DeeJanuz/mcpviews/releases/download/v0.2.42/MCPViews_0.2.42_x64_en-US.msi) |
