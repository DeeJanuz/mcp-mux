...
1. Download **[MCPViews.dmg](https://github.com/DeeJanuz/mcpviews/releases/latest/download/MCPViews_0.2.5-rc.6_aarch64.dmg)** from the latest release
...
|-----------|--------|----------|
| Setup wizard | `.exe` | [MCPViews_setup.exe](https://github.com/DeeJanuz/mcpviews/releases/latest/download/MCPViews_0.2.5-rc.6_x64-setup.exe) |
| MSI package | `.msi` | [MCPViews.msi](https://github.com/DeeJanuz/mcpviews/releases/latest/download/MCPViews_0.2.5-rc.6_x64_en-US.msi) |
